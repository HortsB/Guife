...
public class Administrator {
	...
	public Administrator(int idPerson, String fullNamePerson, String nickNamePerson, String mailPerson,
			String phonePerson, String passwordPerson, String cityPerson) {
		super();
